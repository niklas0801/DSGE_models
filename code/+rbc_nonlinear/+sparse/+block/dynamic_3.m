...
residual=NaN(6, 1);
  ...
  T(6)=params(4)*getPowerDeriv(y(11),(-params(6)),1);
if nargout > 3
    g1_v = NaN(18, 1);
...
g1_v(7)=(-((-params(5))*(-(getPowerDeriv(1-y(13),(-params(7)),1)))))/T(1)-(-(y(10)*(1-params(1))))/(y(13)*y(13));
g1_v(8)=1;
g1_v(9)=1;
...
g1_v(15)=T(6);
g1_v(16)=1;
g1_v(17)=(-((1-params(3)+y(24))*params(2)*params(4)*getPowerDeriv(y(20),(-params(6)),1)));
g1_v(18)=(-T(5));
